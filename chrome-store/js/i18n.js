...
(() => {
  const DICT = {
    'zh-CN': {
      ...
      'settings.manageWallpapers': '管理壁纸',
      'settings.wallpaperLibrary': '壁纸库',
      'settings.readabilitySettings': '可读性设置',
      'settings.wallpaperCount': '{count} 张',
      'settings.rotationEnabled': '轮播中',
      'settings.selectPhotos': '选择照片',
      'settings.selectFolder': '选择文件夹',
      'settings.wallpaperReadability': '自动可读性保护',
      'settings.wallpaperSurfaceMode': '搜索框样式',
      'settings.surfaceAuto': '自适应',
      'settings.surfaceLight': '浅色',
      'settings.surfaceDark': '深色',
      'settings.wallpaperRotation': '自动切换',
      'settings.rotationOff': '关闭',
      'settings.rotation30m': '30分钟',
      'settings.rotation1h': '1小时',
      'settings.rotation2h': '2小时',
      'settings.rotation24h': '24小时',
      'settings.wallpaperRotationMode': '轮播模式',
      'settings.rotationSequence': '顺序',
      'settings.rotationRandom': '随机',
      'settings.wallpaperSelect': '批量管理',
      'settings.wallpaperSelectionDone': '完成',
      'settings.wallpaperDeleteSelected': '删除所选',
      'settings.wallpaperClearAll': '清空全部',
      ...
      'privacy.section3_1.p': '当搜索联想开启时，你在搜索框中输入的关键词会被发送到当前选择的搜索引擎（Google、百度、Bing 或 DuckDuckGo）以获取自动补全建议。通用版默认开启搜索联想，可在设置中关闭；Chrome Web Store 版默认关闭，只有在你开启并授权后才会请求建议接口。提交搜索时，支持“浏览器默认”的版本会调用浏览器默认搜索服务；手动选择其他搜索引擎时，关键词会直接发送到所选搜索服务。这些请求不包含任何个人身份信息或设备标识符。',
      ...
      'privacy.section4.li2': '<strong>主机权限（host_permissions / optional_host_permissions）</strong>：用于向所选搜索引擎发送搜索建议请求。通用版使用固定主机权限，并提供搜索联想开关；Chrome Web Store 版使用可选主机权限，仅在开启搜索联想时请求，关闭后会撤销。',
    ...
    en: {
      ...
      'settings.manageWallpapers': 'Manage Wallpapers',
      'settings.wallpaperLibrary': 'Wallpaper Library',
      'settings.readabilitySettings': 'Readability Settings',
      'settings.wallpaperCount': '{count} wallpapers',
      'settings.rotationEnabled': 'Rotating',
      'settings.selectPhotos': 'Select Photos',
      'settings.selectFolder': 'Select Folder',
      'settings.wallpaperReadability': 'Auto Readability',
      'settings.wallpaperSurfaceMode': 'Search Box Style',
      'settings.surfaceAuto': 'Adaptive',
      'settings.surfaceLight': 'Light',
      'settings.surfaceDark': 'Dark',
      'settings.wallpaperRotation': 'Auto Switch',
      'settings.rotationOff': 'Off',
      'settings.rotation30m': '30 min',
      'settings.rotation1h': '1 hour',
      'settings.rotation2h': '2 hours',
      'settings.rotation24h': '24 hours',
      'settings.wallpaperRotationMode': 'Rotation Mode',
      'settings.rotationSequence': 'Sequence',
      'settings.rotationRandom': 'Random',
      'settings.wallpaperSelect': 'Batch Manage',
      'settings.wallpaperSelectionDone': 'Done',
      'settings.wallpaperDeleteSelected': 'Delete Selected',
      'settings.wallpaperClearAll': 'Clear All',
      ...
      'settings.btnPosFooter': 'Page Bottom',
      ...
      'settings.suggestionsDesc': 'Show search suggestions as you type (requires network permission). Recommended. Search suggestions are not supported when using Browser Default search.',
      ...
      'privacy.section3_1.p': 'When search suggestions are enabled, keywords you enter in the search box are sent to the currently selected search engine (Google, Baidu, Bing, or DuckDuckGo) to retrieve autocomplete suggestions. The generic build enables suggestions by default and lets you turn them off in settings; the Chrome Web Store build keeps suggestions off by default and only requests suggestion APIs after you enable the feature and grant permission. When submitting a search, versions that support "Browser Default" use your browser\'s default search provider; manually choosing another search engine sends the keyword directly to that selected search service. These requests contain no personal identity information or device identifiers.',
      ...
      'privacy.section4.li2': '<strong>Host Permissions (host_permissions / optional_host_permissions)</strong>: Used to send search suggestion requests to the selected search engine. The generic build uses fixed host permissions and provides a search suggestions toggle; the Chrome Web Store build uses optional host permissions, requests them only when suggestions are enabled, and removes them again when suggestions are disabled.',
