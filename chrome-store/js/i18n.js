...
(() => {
  const DICT = {
    'zh-CN': {
      ...
      'about.close': '关闭',
      'about.description': 'WillowTab v1.6.0 强化了壁纸体验，支持批量管理、自动轮播和自适应可读性保护，让新标签页在不同背景下依然清爽易读。',
      'about.version': '版本',
      'about.topic': '主题',
      'about.topicValue': '浏览器新标签页扩展',
      'about.author': '作者',
      'about.github': 'GitHub',
    ...
    en: {
      ...
      'about.close': 'Close',
      'about.description': 'WillowTab v1.6.0 improves the wallpaper experience with batch management, automatic rotation, and adaptive readability protection for a clean new tab on every background.',
      'about.version': 'Version',
      'about.topic': 'Topic',
      'about.topicValue': 'Browser New Tab Extension',
      'about.author': 'Author',
      'about.github': 'GitHub',
